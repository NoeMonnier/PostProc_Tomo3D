...
% triangulated patch defined by FV (a structure with fields 'vertices' % and 'faces'). 
% 
...
if asciiMode 
    ...
    facets(end+1,:) = options.facecolor; fwrite(fid, facets, 'uint16'); 
end  
...
% kevinmoerman@hotmail.com % 15/07/2010 
%-----------------------------------------------------------------------
