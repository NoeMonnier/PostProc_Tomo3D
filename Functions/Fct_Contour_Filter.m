function C=Fct_Contour_Filter(Cont, Echelle_Filtre, Grandissement)
...
NPts = floor(Echelle_Filtre/Grandissement);   % nbre de points pour calculer la pente moyenne aux extrémités du contour
